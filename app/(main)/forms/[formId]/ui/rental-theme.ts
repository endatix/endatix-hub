...
// TODO: Export similar to the default themes e.g. registerSurveyTheme(SurveyTheme);
const rentalThemeLight: ITheme = {
  themeName: "Rental Theme",
  colorPalette: "light",
  isPanelless: true,
...
export { rentalThemeLight, rentalThemeDark };
