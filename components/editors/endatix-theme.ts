export const endatixTheme = {
  themeName: "endatixTheme",
  cssVariables: {
    ...
    "--sjs-primary-background-500": " #0054d1",
    "--sjs-primary-background-10": " #3131311A",
    "--sjs-primary-background-400": " #240973FF",
    "--sjs-primary-foreground-100": " #FFFFFFFF",
    "--sjs-primary-foreground-25": " #FFFFFF40",
    "--sjs-secondary-background-500": " #0054d1",
    "--sjs-secondary-background-25": " #0054D140",
    "--sjs-secondary-background-10": " #3131311A",
    ...
    "--sjs-semantic-blue-background-500": " #0054d1",
    ...
    "--sjs-code-gray-700": " #A4A4A4FF",
    "--sjs-code-blue-500": " #1E5AB3FF",
    "--sjs-code-gray-300": " #1C1C1CFF",
    "--sjs-code-green-500": " #127D60FF",
    "--sjs-code-red-500": " #D30739FF",
    "--sjs-code-purple-500": " #AB228DFF",
    "--sjs-code-yellow-500": " #CC6001FF",
    "--sjs-code-gray-500": " #686868FF",
    "--sjs-special-background": " #FCFDFC",
    ...
    "--sjs-secondary-background-400": " #0054d1",
  },
};
