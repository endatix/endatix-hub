...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn(
        "flex flex-col gap-2 px-2 py-1.5 group-data-[collapsible=icon]:items-center",
        className,
      )}
      {...props}
    />
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto p-2 group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:overflow-hidden group-data-[collapsible=icon]:p-2",
        className,
      )}
      {...props}
    />
...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      className={cn(
        "group/menu-item relative group-data-[collapsible=icon]:self-center",
        className,
      )}
      {...props}
    />
...
function SidebarMenuSkeleton({
  ...
  const width = React.useMemo(() => `${generateRandomNumber(50, 90)}%`, []);
