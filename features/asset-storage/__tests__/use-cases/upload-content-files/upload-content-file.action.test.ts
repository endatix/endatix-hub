...
import { uploadContentFileAction } from "@/features/asset-storage/use-cases/upload-content-files/upload-content-file.action";
...
// Mock the use case
vi.mock(
  "@/features/asset-storage/use-cases/upload-content-files/upload-content-file.use-case",
  () => ({
