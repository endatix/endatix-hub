/**
 * Hard-coded dashboard data from SurveyJS Next.js sample (v1).
 * Source: https://github.com/surveyjs/surveyjs-nextjs/blob/main/data/dashboard_data.js
 * Replace with real form definition and submission-based data when API is wired.
 */

export const MOCK_SURVEY_JSON = {
  completedHtml:
    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          hasOther: true,
          choices: ["Java", "Python", "Node.js", "Go", "Django", "C#", "Ruby"],
          choicesOrder: "asc",
          otherText: "Other",
          colCount: 3,
        },
      ...
      elements: [
        ...
        },
        {
          ...
          choices: [
            ...
            { value: 4, text: "Cannot use your components without it" },
          ],
        },
        {
          type: "radiogroup",
          ...
          title:
            "Which framework are you using or going to use for native mobile developlment?",
          hasOther: true,
          choices: [
            "React Native",
            "NativeScript",
      ...
      elements: [
        {
          ...
          title:
            "What would you use as an alternative if our product didn't exist?",
          isRequired: true,
          hasOther: true,
    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          title:
            "How could our components be improved to meet your needs better?",
        },
      ],
    },
  ],
...
const secondResult: Record<string, unknown> = {
