...
export function submissionListUrlStateFromClientFilters(input: {
  ...
  return {
    ...
    createdFrom: parseSubmissionListCalendarDate(input.createdFrom),
    createdTo: parseSubmissionListCalendarDate(input.createdTo),
    modifiedFrom: parseSubmissionListCalendarDate(input.modifiedFrom),
    modifiedTo: parseSubmissionListCalendarDate(input.modifiedTo),
    startedFrom: parseSubmissionListCalendarDate(input.startedFrom),
    startedTo: parseSubmissionListCalendarDate(input.startedTo),
    completedFrom: parseSubmissionListCalendarDate(input.completedFrom),
    completedTo: parseSubmissionListCalendarDate(input.completedTo),
