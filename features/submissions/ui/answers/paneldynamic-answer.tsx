...
const panelSubgroupClass =
  "w-full min-w-0 rounded-lg bg-surface-container-lowest/60 p-4 shadow-[0_1px_0_rgb(0,52,94,0.04)] dark:bg-surface-container-high/25 dark:shadow-none";
    ...
    >
      {panels.map((panel, index) => (
        <AccordionItem value={panel.id} key={panel.id} className="border-0">
          <AccordionTrigger
            className={cn(
              "rounded-lg bg-surface-container-low/70 px-4 py-3 hover:no-underline",
