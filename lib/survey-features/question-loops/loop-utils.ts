...
import { isLoopQuestion } from "./utils/collect-loop-questions";

/**
 * Gets the page-level loop questions in the survey.
 *
 * @deprecated Only sees loops declared at page level. Use
 * `collectLoopTemplates` / `collectLoopInstances` from `utils/`, which also see
 * loops inside dynamic panels (h938).
 */
