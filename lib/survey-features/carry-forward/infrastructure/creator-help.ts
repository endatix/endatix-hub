...
export function resetAdvancedCarryForwardCreatorHelpForTests(): void {
  ...
  delete translations.pehelp[CARRY_FORWARD_ENABLED_PROPERTY];
  delete translations.pehelp[CARRY_FORWARD_SOURCES_PROPERTY];
  delete translations.pehelp[CARRY_FORWARD_MODE_PROPERTY];
  delete translations.pehelp[CARRY_FORWARD_PRIORITY_ITEMS_PROPERTY];
  delete translations.pehelp[CARRY_FORWARD_MAX_CHOICES_PROPERTY];
