...
const NAMING_CONVENTIONS: ColumnAliasNamingConventionDto[] = [
  ...
  },
  {
    ...
    description: 'Sequential Q1, Q1_1, Q2-style headers grouped by source question.',
    example: 'Q1, Q1_1, Q2',
  },
];
...
describe('export format display helpers', () => {
  it('labels column naming from the naming conventions catalog', () => {
    expect(getColumnAliasProfileLabel('native', NAMING_CONVENTIONS)).toBe('Survey keys');
