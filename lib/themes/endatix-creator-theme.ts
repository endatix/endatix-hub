const sharedCssVariables = {
  ...
  "--sjs-layer-1-background-400": "var(--content-canvas)",
  ...
  "--sjs-layer-2-background-500": "var(--content-canvas)",
  "--sjs-layer-2-background-400": "var(--content-canvas)",
  "--sjs-layer-2-foreground-100": "var(--foreground)",
  "--sjs-layer-2-foreground-75":
    "color-mix(in srgb, var(--foreground) 75%, transparent)",
  "--sjs-layer-2-foreground-50":
    "color-mix(in srgb, var(--foreground) 65%, transparent)",
  "--sjs-layer-3-background-500": "var(--content-canvas)",
  "--sjs-layer-3-background-400": "var(--content-canvas)",
  ...
  "--sjs-code-gray-700":
    "color-mix(in srgb, var(--foreground) 60%, var(--content-canvas))",
  ...
  "--sjs-code-gray-500":
    "color-mix(in srgb, var(--foreground) 45%, var(--content-canvas))",
  "--sjs-special-background": "var(--content-canvas)",
